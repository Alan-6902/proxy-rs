...
<p align="center">
  <img src="resources/icon.png" width="128" height="128" alt="Proxy RS Logo">
</p>
...
- **移除内置反代** — OpenAI/Claude 兼容的 API 反代服务器、账号轮询池、API Key 管理、一键客户端配置，以及只为反代池供货的「自动车凭证同步」全部删除。反代改由外部 kiro-rs 承担。账号管理、注册、席位、代理池（出口 IP 轮换）、账号验活、订阅查询与一键诊断不受影响。
