...
const endpointCircuitStates = new Map<string, EndpointCircuitState>()

function endpointCircuitKey(account: ProxyAccount, endpoint: KiroEndpoint): string {
...
function recordEndpointFailure(account: ProxyAccount, endpoint: KiroEndpoint): void {
