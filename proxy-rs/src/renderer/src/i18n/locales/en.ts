...
const en = {
  ...
  register: {
    ...
    gptMailDesc:
      'GPTmail (mail.chatgpt.org.uk) via Cloudflare Email Routing: register a receiving inbox on GPTmail, set Cloudflare to forward *@yourdomain → that inbox, and we poll the GPTmail API to extract codes.',
    emailLabel: 'Email',
