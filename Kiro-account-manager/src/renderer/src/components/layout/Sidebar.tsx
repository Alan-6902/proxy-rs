import { Home, Users, Settings, Info, ChevronRight, Sparkles, Server, UserPlus, CreditCard, ScrollText, Network, Bell, Stethoscope, Archive } from 'lucide-react'
...
export type PageType = 'home' | 'accounts' | 'kiroSettings' | 'proxy' | 'proxyPool' | 'register' | 'subscription' | 'webhooks' | 'diagnose' | 'configSync' | 'logs' | 'settings' | 'about'
